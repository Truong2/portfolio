...
function BookControls() {
  ...
  return (
    <div className="pointer-events-none absolute inset-x-0 bottom-2 z-20 flex justify-center">
      <div className="pointer-events-auto flex items-center gap-1 rounded-xl border border-white/[0.07] bg-[#030916]/86 px-1 py-1 text-slate-200 shadow-[0_14px_42px_rgba(0,0,0,.32)] backdrop-blur-xl">
...
function JumpToPage() {
  ...
  return (
    <aside className="hidden xl:block" aria-label="Jump to CV page">
      ...
      <div className="mt-3 flex gap-2 rounded-[15px] border border-cyan-300/[0.08] bg-cyan-300/[0.025] p-3 text-[8px] leading-4 text-slate-500">
        <MousePointer2 className="mt-0.5 size-3.5 shrink-0 text-cyan-300" />
...
function CopyrightDock() {
  return <div className="absolute bottom-3 right-4 z-30 hidden rounded-xl border border-white/[0.06] bg-[#050b17]/72 px-4 py-2 text-[7px] text-slate-600 backdrop-blur-xl xl:block">© Nguyen Van Truong. All rights reserved.</div>;
}

function CoverInstruction() {
  return (
    <div className="absolute bottom-24 right-1 z-30 hidden w-44 items-center gap-3 rounded-xl border border-white/[0.07] bg-[#07101f]/82 p-3 text-[8px] leading-4 text-slate-400 backdrop-blur-xl 2xl:flex">
      <div className="relative flex size-10 shrink-0 items-center justify-center rounded-lg border border-cyan-300/10 bg-cyan-300/[0.025]">
